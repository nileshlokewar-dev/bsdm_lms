<style>
    ...
    <div class="container-fluid">
      <div class="row">
          <div class="col-md-12 col-sm-12 mb-4 d-flex align-items-stretch">
            <div class="card-box video-box-main video-container">
              <video id="videoPlayer1" width="100%" height="600" poster="<?php echo base_url();?>assets/images/video-cover-img.webp" controls>
                <source src="<?php echo base_url();?>assets/images/video/dumy-video.mp4" type="video/mp4">
                </object>
              </video>
              ...
              <!-- <a class="play-btn" href="successfully-completed-chapter.html"><img height="60px" class="" src="../images/icons/play-icon.webp" /></a> -->
               <div class="text-end">
                  <a id="move_next" class="btn" href="chapter_one_completed" style="display:none;">Next</a>
               </div>
  ...
  <script>
    $(document).ready(function () {
      ...
      const videoId = 'example-video-1'; // Unique ID for the video
